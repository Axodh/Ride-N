              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="POST" action="">
                      ...
                      <p>Address</p>
                      <input name="addr" type="text" value="'.$member->addressUser.'"/>
                      <p>City</p>
                      <input name="city" type="text" value="'.$member->cityUser.'"/>
                      <p>ZipCode</p>
                      <input name="zip" type="text" value="'.$member->zipCode.'"/>
                      <p>Number</p>
                      <input name="number" type="text" value="'.$member->numberUser.'"/>
                      <div class="modal-footer"> <button type="button" class="btn btn-primary" onclick="modify(\''.$user.'\',\''.$member->mailUser.'\',\''.$member->nameUser.'\',\''.$member->surnameUser.'\',\''.$member->addressUser.'\',\''.$member->cityUser.'\',\''.$member->zipCode.'\',\''.$member->numberUser.'\')">Save changes</button> <button type="button" onclick="closeModal(\''.$member->mailUser.'\')" class="btn btn-secondary" data-dismiss="modal">Close</button> </div>
                    </form>
                    </div>
                </div>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="POST" action="">
                      ...
                      <div class="modal-footer"> <button type="button" class="btn btn-primary" onclick="modifyDriver(\''.$driver.'\',\''.$member->mailDriver.'\',\''.$member->nameDriver.'\',\''.$member->lastNameDriver.'\',\''.$member->addr.'\',\''.$member->number.'\',\''.$member->age.'\')">Save changes</button> <button type="button" onclick="closeModal(\''.$member->mailDriver.'\')" class="btn btn-secondary" data-dismiss="modal">Close</button> </div>
                    </form>
                    </div>
                </div>
