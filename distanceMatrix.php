...
if(empty($date) && empty($time)) echo "Choisissez une date et une heure";
if(empty($departure) && empty($arrival)) echo "Les champs sont vides";
if(!isConnected()) echo "Vous devez vous connecter pour commander";
