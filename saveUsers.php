...
if( count($_POST) == 9
    ...
    if($error) {
        ...
        $query = $db->prepare("INSERT INTO user (nameUser, surnameUser, mailUser, pwd, addressUser, cityUser, zipCode, numberUser) VALUES (:nameUser, :surnameUser, :mailUser, :pwd, :addressUser, :cityUser, :zipCode, :numberUser)");
