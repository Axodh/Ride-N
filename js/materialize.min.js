...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var options = {
        alignment: 'right',
        coverTrigger: false,
        onOpenEnd: function() { document.getElementById("changing-arrow").innerText = "arrow_drop_up" },
        onCloseEnd: function() { document.getElementById("changing-arrow").innerText = "arrow_drop_down" }
    }
