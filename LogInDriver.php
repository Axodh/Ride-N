<?php $pageTitle = "Log In Driver";
require_once "navbar.php" ?>
<main>
    <div class="text-center">
        <div class="container">
            <div class="row">
                <h1 class="center white-text" style="font-variant: small-caps"><?php echo $GLOBALS['LOG_IN_TITLE'] ?> - driver</h1><br>
                <form method="POST" action="connexionDriver.php" class="col s12">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="mailLog" type="email" class="validate" name="mailDriver">
                            <label for="mailLog"><?php echo $GLOBALS['LOG_IN_MAIL'] ?></label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="pwdLog" type="password" class="validate" name="pwdDriver">
