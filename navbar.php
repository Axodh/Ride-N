    ...
    <nav class="transparent z-depth-0">
        <div class="nav-wrapper">
            <div class="row">
                ...
                <div class="col s4 l8 center show-on-medium-and-down hide-on-large-only"><i class="material-icons">arrow_drop_down</i></div>
                <div class="col s4 l8 center smol hide-on-med-and-down">
                ...
                <div class="col s4 l2 center smol">
                    <?php if(!isConnected()){
                        ...
                        echo '<a href="#" class="pad hide-on-med-and-down">' .$GLOBALS['NAV_HELLO']. ', ' .$_SESSION["surnameConnected"]. ' !</a>';
                        echo '<a href="#" class="show-on-medium-and-down hide-on-large-only">' .$_SESSION["surnameConnected"]. '</a>';
                        echo '<a href="deconnexion.php" class="pad hide-on-med-and-down">' .$GLOBALS['LOG_OUT_TITLE']. '</a>';
                    } ?>
                </div>
            </div>
        </div>
